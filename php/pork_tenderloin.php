...
<body>
    ...
    <div class="wholeBox">
        <img class="productImage" src="../images/Meat/porkTenderloin.jpg" alt="">
        
		<div class="description">
            <div class="information">
                <h2 name="p3applename">Pork Tender Loin</h2>

                <h4 class='priceEachap' name="p3applepriceunit">8.42</h4>
                <h4>$18.72 / kg</h4>
            </div>
            <div>
