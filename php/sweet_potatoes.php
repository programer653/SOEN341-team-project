...
<body>
    ...
    <div class="wholeBox">
        <img class="productImage" src="../images/Vegetables/sweet_potatoes.jpg" alt="">
        
		<div class="description">
            <div class="information">
                <h2 name="p3applename">Sweet Potatoes</h2>

                <h4 class='priceEachap' name="p3applepriceunit">1.32</h4>
                <h4>$4.39 / kg</h4>
            </div>
            <div>
